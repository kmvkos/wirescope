...
tty1 и открывает Chromium на `http://127.0.0.1:8000/`. С дома: **Прослушивание**
пишет pcap с выбранного NIC (фильтр tcpdump по желанию). Без SPAN на коммутаторе
видны broadcast/flooded и unicast на MAC этого интерфейса; promiscuous пишет
всё, что NIC принимает, не весь сегмент.
