...
_PRODUCT_COHERENCE_ASSET_VERSION = "20260827-ui26"
_PCAP_MANAGEMENT_ASSET_VERSION = "20260827-ui27"
    ...
    def root() -> HTMLResponse:
        ...
        page = page.replace(
            ...
            (
                ...
                '<script type="application/json" id="wirescope-topology-extra-assets">'
                f'{{"snmp":"/static/snmp_topology.js?v={_UI_ASSET_VERSION}&feature={_SNMP_TOPOLOGY_ASSET_VERSION}",'
                f'"ssh":"/static/ssh_topology.js?v={_SSH_TOPOLOGY_ASSET_VERSION}"}}'
                '</script>\n'
