...
active, and protocol-audit end-to-end tests use fixtures and do not scan the
live network. Live Nmap or protocol probes require an explicit
`WIRESCOPE_LIVE_SCOPE` and `pytest -m network`.
